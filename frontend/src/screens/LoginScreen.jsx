...
const LoginScreen = () => {
    ...
    const oauth_secret = '1025156040682-9rt302r4rcrp05g6ju4ncdh70at3uad6.apps.googleusercontent.com'
    ...
    <div class="py-6 px-4">
      <div class="">
        {/* <div class="max-md:text-center">
          ...
          <p class="text-sm mt-10">Don't have an account <Link to={redirect ? `/register?=${redirect}` : '/register'}> <a class="text-blue-600 font-semibold hover:underline ml-1">Register here</a> </Link> </p>
        </div> */}
        <form class="w-5/12 mx-auto">
          ...
          <p class="my-5 text-sm text-gray-400 text-center">or continue with</p>

          <div class="space-x-6 flex justify-center">
            <GoogleOAuthProvider clientId="1025156040682-9rt302r4rcrp05g6ju4ncdh70at3uad6.apps.googleusercontent.com">
              <GoogleLogin
