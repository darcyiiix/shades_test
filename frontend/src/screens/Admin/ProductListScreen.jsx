        ...
        <>
            <div className="flex flex-col">
                <button
                    ...
                    className="focus:outline-none text-white bg-primary rounded-lg text-sm px-5 py-2.5 me-2 mb-4 text-center self-end"
                >
                    <FaEdit className="inline-block" /> Create Product
                </button>
                                    ...
                                    {data.products.map((product) => (
                                        <tr className="odd:bg-white even:bg-gray-50 border-b" key={product._id}>
                                            ...
                                            <td className="px-6 py-4">
                                                ...
                                                >
                                                    <FaEdit className="inline-block text-black size-4 mr-2" />
                                                </a>
                                                <a
                                                    href="#"
                                                    ...
                                                    className="font-medium text-blue-600 hover:underline"
                                                >
                                                    <FaTrash className="inline-block bg-red-500 text-white py-1 size-5 rounded" />
                                                </a>
                                                <button
                                                    onClick={() => copyProductHandler(product._id)}
